...
import bashar.astifan.ismart.smart.adapter.pinned.SackOfViewsAdapter;
 ...
 *
 */
public class iListAdapterMerger extends BaseAdapter implements SectionIndexer,PinnedSectionedHeaderAdapter {
  protected PieceStateRoster pieces=new PieceStateRoster();

  /**
   * Stock constructor, simply chaining to the superclass.
   */
  public iListAdapterMerger() {
    super();
  }
...
public boolean isSectionHeader(int position) {
	// TODO Auto-generated method stub
	 for (ListAdapter piece : getPieces()) {
	      ...
	      if (position < size) {
	        return(((PinnedSectionedHeaderAdapter) piece).isSectionHeader(position));
	      }
...
public int getSectionPosition(int position) {
	...
	for (ListAdapter piece : getPieces()) {
	      int size=piece.getCount();
	      if (position < size) {
	        return(((PinnedSectionedHeaderAdapter) piece).getSectionPosition(position));
	      }
	      position-=size;
	    }
	 return 0;
...
public iSmartAdapter.iListHeader getSubHeader() {
	// TODO Auto-generated method stub
	for (ListAdapter piece : getPieces()) {
	        return(((PinnedSectionedHeaderAdapter) piece).getSubHeader());
	    }
	 return null;
}
